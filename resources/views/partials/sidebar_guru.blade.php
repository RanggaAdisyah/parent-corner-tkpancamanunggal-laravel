...
<aside class="aside" id="mainSidebar" aria-label="Sidebar navigasi">
    <div class="horizontal-border">
        ...
        <div class="div-wrapper">
            <div class="div">
                ...
                <div class="div-2"><div class="text-wrapper">Parent Corner &amp; Staff</div></div>
            </div>
        </div>
    ...
    <nav class="nav" aria-label="Navigasi utama">
        ...
        <a href="{{ url('/guru/kehadiran') }}" class="{{ isset($active) && $active == 'input-kehadiran' ? 'link' : 'link-2' }}" title="Input Kehadiran">
            <div class="div"><img class="icon-2" src="{{ asset('icon/guru/kehadiran.svg') }}" alt="" /></div>
            <div class="div-wrapper"><div class="{{ isset($active) && $active == 'input-kehadiran' ? 'text-2' : 'text-wrapper-3' }}">Input Kehadiran</div></div>
        </a>
        <a href="{{ url('/guru/nilai') }}" class="{{ isset($active) && $active == 'input-nilai' ? 'link' : 'link-2' }}" title="Input Nilai">
            <div class="div"><img class="icon-2" src="{{ asset('icon/guru/nilai.svg') }}" alt="" /></div>
            <div class="div-wrapper"><div class="{{ isset($active) && $active == 'input-nilai' ? 'text-2' : 'text-wrapper-3' }}">Input Nilai</div></div>
        </a>
        <a href="{{ url('/guru/lihat-jadwal') }}" class="{{ isset($active) && $active == 'lihat-jadwal' ? 'link' : 'link-2' }}" title="Lihat Jadwal">
...
@endphp
            <a href="{{ route('guru.profil') }}" style="display:flex; align-items:center; text-decoration:none; color:inherit;">
                ...
                <div class="margin">
                    <div class="div-2">
                        <div class="div-2"><div class="text-wrapper-4" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:140px; transition: color 0.2s;" onmouseover="this.style.color='#6366f1'" onmouseout="this.style.color=''" title="{{ $nama }}">{{ $nama }}</div></div>
...
<div class="ot-drawer" id="otDrawer" aria-label="Menu navigasi">
    <div class="ot-drawer__header">
        <div class="ot-drawer__logo">Parent Corner</div>
    ...
    <nav class="ot-drawer__nav">
        {{-- Beranda --}}
        <a href="{{ url('/guru/dashboard') }}" class="ot-drawer__link {{ isset($active) && $active == 'dashboard' ? 'active' : '' }}">
        ...
        <div class="ot-drawer__group">
            ...
            <div class="ot-drawer__subnav {{ $isAkademikActive ? 'open' : '' }}" id="subnavAkademik">
                <a href="{{ url('/guru/kehadiran') }}" class="ot-drawer__sublink {{ isset($active) && $active == 'input-kehadiran' ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="20 6 9 17 4 12"/></svg>
                    Input Kehadiran
                </a>
                <a href="{{ url('/guru/nilai') }}" class="ot-drawer__sublink {{ isset($active) && $active == 'input-nilai' ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
                    Input Nilai
                </a>
                <a href="{{ url('/guru/lihat-jadwal') }}" class="ot-drawer__sublink {{ isset($active) && $active == 'lihat-jadwal' ? 'active' : '' }}">
        ...
        {{-- Profil --}}
        <a href="{{ route('guru.profil') }}" class="ot-drawer__link {{ isset($active) && $active == 'profil' ? 'active' : '' }}">
    ...
    <div class="ot-drawer__footer">
        <a href="{{ route('guru.profil') }}" style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 0; text-decoration: none; color: inherit;">
