...
@endphp
            <a href="{{ url('/orang-tua/profil') }}" style="display:flex; align-items:center; text-decoration:none; color:inherit;">
                ...
                <div class="margin">
                    <div class="div-2">
                        <div class="div-2"><div class="text-wrapper-4" style="white-space:nowrap; overflow:hidden; text-overflow:ellipsis; max-width:140px; transition: color 0.2s;" onmouseover="this.style.color='#3b82f6'" onmouseout="this.style.color=''" title="{{ $nama }}">{{ $nama }}</div></div>
...
<div class="ot-drawer" id="otDrawer" aria-label="Menu navigasi">
    ...
    <div class="ot-drawer__footer">
        <a href="{{ url('/orang-tua/profil') }}" style="display: flex; align-items: center; gap: 10px; flex: 1; min-width: 0; text-decoration: none; color: inherit;">
