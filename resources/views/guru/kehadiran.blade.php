    ...
    <div class="dashboard-guru">
        ...
        <main class="main">
                ...
                <section class="filter-section">
                    <div class="filter-group">
                        ...
                        <div class="filter-input-wrapper">
                            ...
                            <input type="date" name="tanggal" class="filter-input" value="{{ date('Y-m-d') }}" style="width:100%; border:none; outline:none; font-family:inherit; color:#1e293b; background:transparent;">
                        </div>
                    </div>
                </section>
            ...
            <section class="attendance-card">
                <header class="attendance-header">
                    <div class="attendance-title-wrapper">
                        ...
                        <h2 class="attendance-title">Daftar Siswa ({{ count($siswas) }} Siswa)</h2>
                    </div>
                        ...
                        <tr>
                            ...
                            <td class="col-status">
                                <div class="status-options">
                                    ...
                                    <label class="status-option">
                                        <input type="radio" name="kehadiran[{{ $siswa->id }}]" value="izin" class="status-radio radio-izin"> Izin
                                    </label>
                                    <label class="status-option">
                                        <input type="radio" name="kehadiran[{{ $siswa->id }}]" value="alpa" class="status-radio radio-alfa"> Alfa
                                    </label>
                                </div>
                            </td>
                            <td class="col-note">
                                <input type="text" name="keterangan[{{ $siswa->id }}]" class="note-input" placeholder="Catatan (opsional)">
                            </td>
                        </tr>
                        @empty
                        <tr>
            ...
            <footer class="footer-actions">
                <a href="{{ route('guru.dashboard') }}" class="btn-batal" style="text-decoration:none; display:inline-flex; align-items:center; justify-content:center;">Batal</a>
