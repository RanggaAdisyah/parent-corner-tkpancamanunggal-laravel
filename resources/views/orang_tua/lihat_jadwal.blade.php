        ...
        <main class="main">
            <header class="header">
                <div class="header-left">
                    ...
                    <p class="page-subtitle">Lihat jadwal pelajaran dan kalender kegiatan TK Panca Manunggal untuk Ananda {{ $siswa ? $siswa->nama : '...' }}.</p>
                </div>
                    ...
                    <div class="jh-kelas-panel active" id="panel-jadwal">
                        ...
                        @foreach($hariList as $i => $hari)
                            <div class="jh-schedule {{ $i===0?'active':'' }}" id="hari-{{ $hari }}">
                                <div class="jh-badge">Kelas {{ $siswa && $siswa->kelasLokal ? $siswa->kelasLokal->nama_kelas : 'Belum Ditentukan' }} &nbsp;&middot;&nbsp; {{ $hari }}</div>
