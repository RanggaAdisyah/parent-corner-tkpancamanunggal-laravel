    ...
    <div class="dashboard-guru">
        ...
        <main class="main ot-main">
            ...
            <section class="activity-grid">
                ...
                {{-- Contribution Card --}}
                <div class="activity-card-contrib">
                    <div class="contrib-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"></path><circle cx="12" cy="13" r="4"></circle><line x1="12" y1="9" x2="12" y2="13"></line><line x1="10" y1="11" x2="14" y2="11"></line></svg>
                    </div>
                    <span class="contrib-text">Kontribusi Foto?</span>
                </div>
