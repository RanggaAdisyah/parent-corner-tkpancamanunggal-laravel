...
<head>
    ...
    <meta charset="utf-8" />
    <title>Buat Galeri - Operator Panel</title>
    ...
    <div class="dashboard-guru buat-pengumuman">
        ...
        <main class="main">
            ...
            <div class="responsive-container">
                <form id="formGaleri" method="POST" action="{{ route('operator.galeri.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div style="display:flex; justify-content:flex-end; gap:16px; margin-top:40px; padding-top:24px; border-top:1px solid #e2e8f0;">
                        ...
                        <button type="submit" style="padding:10px 24px; border-radius:8px; font-weight:600; font-size:14px; color:#fff; background:#3b82f6; border:none; cursor:pointer;">Kirim Galeri</button>
                    </div>
                </form>
            </div>
