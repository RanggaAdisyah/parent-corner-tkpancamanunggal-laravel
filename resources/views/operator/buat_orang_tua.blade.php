                        ...
                        <div>
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <input type="email" name="email" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Contoh: bapak@email.com" required value="{{ old('email') }}" />
                                </div>
                                <div class="form-group" style="margin-bottom: 20px;">
