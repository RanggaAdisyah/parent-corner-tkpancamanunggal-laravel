        ...
        <main class="main">
            <header class="page-header" style="flex-direction: column; align-items: flex-start; gap: 16px;">
                ...
                <div class="header-left">
                    <h1 class="header-title">Ubah Data Guru</h1>
                    <p class="header-subtitle">Perbarui data pribadi dan kredensial login guru.</p>
                </div>
            </header>
            ...
            <div class="responsive-container">
                ...
                @endif
                <form method="POST" action="{{ route('operator.kelola-guru.update', $guru->user_id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div>
                            ...
                            <div class="form-grid">
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <input type="text" name="no_hp" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Contoh: 081234567890" required value="{{ old('no_hp', $guru->no_hp) }}" />
                                </div>
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <input type="email" name="email" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="guru@sekolah.com" required value="{{ old('email', $guru->user ? $guru->user->email : '') }}" />
                                </div>
                            </div>
                            
                            <div class="form-group" style="margin-bottom: 20px;">
                                <label class="form-label" style="display:block; margin-bottom:8px; font-weight:600; font-size:14px;">Password Baru <span style="color:#64748b; font-weight:normal; font-size:12px;">(Kosongkan jika tidak ingin mengubah)</span></label>
                                <input type="password" name="password" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Minimal 6 karakter" />
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="form-grid">
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <input type="text" name="nama_lengkap" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Nama lengkap beserta gelar" required value="{{ old('nama_lengkap', $guru->nama_lengkap) }}" />
                                </div>
                                <div class="form-group" style="margin-bottom: 20px;">
                                    <label class="form-label" style="display:block; margin-bottom:8px; font-weight:600; font-size:14px;">Jabatan</label>
                                    <input type="text" name="jabatan" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Contoh: Guru Kelas, Kepala Sekolah" value="{{ old('jabatan', $guru->jabatan) }}" />
                                </div>
                            </div>
                            ...
                            <div class="form-grid">
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <input type="text" name="nip" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc;" placeholder="Masukkan NIP" value="{{ old('nip', $guru->nip) }}" />
                                </div>
                                <div class="form-group" style="margin-bottom: 20px;">
                                    ...
                                    <select name="kelas_id" class="form-input" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc; appearance: auto;">
                                        ...
                                        @foreach($kelasList as $kelas)
                                            <option value="{{ $kelas->id }}" {{ old('kelas_id', $guru->kelas_id) == $kelas->id ? 'selected' : '' }}>{{ $kelas->tingkat }} - {{ $kelas->nama_kelas }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="margin-bottom: 20px;">
                                ...
                                <textarea name="alamat" style="width:100%; padding:12px; border:1px solid #e2e8f0; border-radius:8px; background:#f8fafc; min-height:80px;" placeholder="Masukkan alamat lengkap">{{ old('alamat', $guru->alamat) }}</textarea>
                            </div>
                        </div>
