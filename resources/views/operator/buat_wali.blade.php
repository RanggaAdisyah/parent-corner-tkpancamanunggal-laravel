...
<head>
    ...
    <meta charset="utf-8" />
    <title>Buat Akun Wali - Operator Panel</title>
        ...
        <main class="main">
            <header class="page-header" style="flex-direction: column; align-items: flex-start; gap: 16px;">
                ...
                <div class="header-left">
                    <h1 class="header-title">Tambah Akun Wali Baru</h1>
                    <p class="header-subtitle">Lengkapi data wali dan tautkan dengan data siswa.</p>
                </div>
            </header>

            <div class="responsive-container">
                <form method="POST" action="{{ route('operator.kelola_wali.store') }}">
                    @csrf
                    ...
                    <div class="form-layout">
                        ...
                        <div>
                            ...
                            <p style="font-size:14px; color:#64748b; margin-bottom:24px;">Cari dan pilih siswa yang akan ditautkan ke akun wali ini. Maksimal 5 siswa (Siswa pertama wajib).</p>
                    ...
                    <div style="margin-top: 40px; padding-top: 24px; border-top: 1px solid #e2e8f0; display: flex; justify-content: flex-end; gap: 16px;">
                        ...
                        <button type="submit" style="padding: 12px 24px; background: #3b82f6; color: white; border: none; font-weight: 600; border-radius: 8px; cursor: pointer;">Simpan Akun Wali</button>
                    </div>
                </form>
            </div>
